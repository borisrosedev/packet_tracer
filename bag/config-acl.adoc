...
Vous avez un réseau simple avec un routeur, plusieurs PCs connectés via un switch, ...

=== ...

et vous voulez configurer des ACLs pour permettre ou bloquer l'accès à certains services ou réseaux.
